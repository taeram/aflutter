...
setenv_variables = ['AWS_ACCESS_KEY_ID', 'AWS_REGION', 'AWS_S3_BUCKET', 'AWS_SECRET_ACCESS_KEY', 'GOOGLE_ANALYTICS_ID', 'MAX_UPLOAD_SIZE', 'SECRET_KEY', 'SITE_NAME', 'FILES_PROTECTED', 'DATABASE_URL', 'FLASK_ENV']
